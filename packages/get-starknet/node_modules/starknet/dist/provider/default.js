    ...
    Provider.prototype.getTransactionReceipt = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, axios_1.default.get((0, url_join_1.default)(this.feederGatewayUrl, 'get_transaction_receipt', "?".concat((0, utils_1.txIdentifier)(txHash, txId))))];
                    case 1:
                        data = (_b.sent()).data;
                        return [2 /*return*/, data];
                }
